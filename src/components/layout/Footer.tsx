        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-6 mb-4 md:mb-0">
              <Link to="/about" className="text-gray-600 hover:text-manmul-600 text-sm">
                About Us
              </Link>
              <Link to="/contact" className="text-gray-600 hover:text-manmul-600 text-sm">
                Contact
              </Link>
              <Link to="/terms" className="text-gray-600 hover:text-manmul-600 text-sm">
                Terms & Conditions
              </Link>
              <Link to="/privacy" className="text-gray-600 hover:text-manmul-600 text-sm">
                Privacy Policy
              </Link>
            </div>
            
            <div className="flex space-x-4">
              <a href="#" className="text-gray-600 hover:text-manmul-600">
